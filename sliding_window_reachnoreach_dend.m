...
file_name_out = [dir_all, 'corrmovav_reachnoreach_DEND_2sec'];
           ...
           %%%%%rest correlation calculations%%%%%
                ...
                collect_rest_between = [];
                    ...
                    for IC_ix = 1:length(index_collect)-1
                        ...
                        pixel_list = find(IC_map_2D == dom);
                        df_within = hU(pixel_list,:)*hS*hV(rest_window_all,:)';
                        
                        R_within = corrcoef(df_within');
                        mean_within = mean(R_within,2);
                        ...
                        collect_rest_within = [collect_rest_within; mean_within];    
