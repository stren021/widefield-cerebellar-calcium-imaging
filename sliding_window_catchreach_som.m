...
file_name_out = [dir_all, 'corrmovav_catchreach_SOM_2sec'];
...
%     tcurr = tcurr(p_true);
        ...
        if beep_ix < length(bcurr)
           ...
           %%%%%rest correlation calculations%%%%%
                ...
                for pix = 1:2
                    switch pix
                        ...
                        case 2
                            ...
                            taus = reach_taus;
                            collect_all_within = collect_within_catch;
                ...
                switch pix 
                    ...
                    case 2
                        collect_within_catch = collect_all_within;
 ...
 within_av_catch = mean(collect_within_catch);
 ...
 collect_av_within_catch = [collect_av_within_catch [mouse_ix; day_ix; within_av_catch']];
 ...
 within_z_catch = (collect_within_catch./collect_av_within_rest);
 between_z_catch = (collect_between_catch./collect_av_between_rest);
 within_z_catch_mean = mean(collect_within_catch./collect_av_within_rest);
...
collect_z_within_catch = [collect_z_within_catch [mouse_ix; day_ix; within_z_catch_mean']];
collect_z_between_catch = [collect_z_between_catch [mouse_ix; day_ix; between_z_catch_mean']];



 COLLECT_ALL_WITHIN_CATCH = [COLLECT_ALL_WITHIN_CATCH; within_z_catch];
...
'COLLECT_ALL_WITHIN_CATCH', 'COLLECT_ALL_BETWEEN_CATCH', 'collect_z_within_catch',...
    'collect_z_between_catch', 'collect_av_within_catch','collect_av_between_catch');
