...
%averages, bins, and plots spatial maps for each reaching epoch from the
%previous function
            ...
            % Set bin (bin x bin square)
                ...
                % Create empty matrix to store data in
                       ...
                       bin_max = round(image_size/bin);
                        ...
                        sem_x = nanstd(binned_map,0,1)./sqrt(size(binned_map,1));
                        sem_y = nanstd(binned_map,0,2)./sqrt(size(binned_map,1));
                        ...
                        if wix == 1
                            ...
                            figure(pix);subplot(1,3,wix-1);imagesc(diff_map,'AlphaData',imAlpha);axis square;caxis([-0.15 0.15])
